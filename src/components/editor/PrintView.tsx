 ...
 *
 * Split out of app/print/page.tsx so that page can be a server component and
 * render per-request for the CSP nonce. See src/proxy.ts.
 */
...
export function PrintView() {
  ...
  // Subscribing to the persist API directly is not viable here: the route is
  // server-rendered first, where there is no localStorage and
  // `useDeckStore.persist` is not available yet.
